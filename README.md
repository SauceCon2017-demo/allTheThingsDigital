...
2. Sauce Credentials
    * In the terminal export your Sauce Labs Credentials as environmental variables:
	...
	$ export TO_WEB_ACCESS_KEY=<your TestObject access key>
	$ export TO_IOS_ACCESS_KEY=<your TestObject access key>
	$ export TO_ANDROID_ACCESS_KEY=<your TestObject access key>
    ```
